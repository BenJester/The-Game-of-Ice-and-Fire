...
class initialcanvas():
    ...
    def __init__(self):
        ...
        self.gamemodeinstruction = Label(text="Press up to enter A Game of Jump and Dodge\nPress F to enter A Game of Immune")
        self.gamemodeinstruction.pack(anchor=CENTER)


        self.initialcanvas = Canvas(width=500,height=220)
        self.initialcanvas.pack()
        self.initialcanvas.create_line(0,175, 500,175, width=1)
        #self.canvas.create_line(45,175,95,125,width=1)

        self.initialcanvas.create_rectangle(self.posa, self.posb, self.posc, self.posd, outline=self.color) #Ball size 45*45
    ...
    def keyPressed(self,event):
        ...
        if event.keysym == "Up":
            ...
            self.jumpmode = canvas()
            self.initialcanvas.destroy()
            self.gamemodeinstruction.destroy()

        if event.keysym == "f":

            print "Immune!"

            self.immunemode = canvasi()
            self.initialcanvas.destroy()
            self.gamemodeinstruction.destroy()
    ...
    def energybar(self):
        ...
        if self.energy < 0:
            self.energy = 0.0
            self.initialcanvas.create_rectangle(self.ebposleft,80, self.ebposright,85, outline="grey")
            self.initialcanvas.create_rectangle(self.ebposleft,80, self.ebdrawright,85, outline="grey", fill="grey")


#gamemodeselection = initialcanvas()
...
class canvas():
    ...
    def __init__(self):
        ...
        self.gamemode_select()
        self.gamemode_selecting = True
        ...
        self.instruction = Label(text="Press up to start jumping\nPress F to immune\n"\
                                          "Press D to pause\nPress E to use bomb")
    ...
    def energybar(self):
        ...
        if self.energy < 0:
            self.energy = 0.0
        self.canvas.create_rectangle(self.ebposleft,80, self.ebposright,85, outline="grey")
        self.canvas.create_rectangle(self.ebposleft,80, self.ebdrawright,85, outline="grey", fill="grey")
    ...
    def drawALL(self):
        ...
        self.canvas = Canvas(width=500,height=220)
        self.canvas.pack()
        self.canvas.create_line(0,175, 500,175, width=1)
        #self.canvas.create_line(45,175,95,125,width=1)

        self.canvas.create_rectangle(self.posa, self.posb, self.posc, self.posd, outline=self.color) #Ball size 45*45
    ...
    def rectmove(self):
        ...
        for x in range(0, len(self.rects)):
            ...
            if self.rects[x][2] <= 0.0:
                ...
                self.canvas.create_rectangle(self.rects[x][0], 175.0, self.rects[x][2], 150.0)
    ...
    def bomb(self):
        ...
        if self.bombposx2 <= 600:
            self.canvas.create_oval(self.bombposx1,self.bombposy1,self.bombposx2, self.bombposy2)
